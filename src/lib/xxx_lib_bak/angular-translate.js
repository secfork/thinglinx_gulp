...
angular.module('pascalprecht.translate').provider('$translate', [
  ...
  function ($STORAGE_KEY) {
    var $translationTable = {}, $preferredLanguage, $availableLanguageKeys = [], $languageKeyAliases, $fallbackLanguage, $fallbackWasString, $uses,
        $nextLang, $storageFactory, $storageKey = $STORAGE_KEY,
        $storagePrefix, $missingTranslationHandlerFactory, $interpolationFactory,
    ...
    this.$get = [
      ...
      function ($log, $injector, $rootScope, $q) {
        var Storage,
            ...
            pendingLoader = false, interpolatorHashMap = {}, langPromises = {},

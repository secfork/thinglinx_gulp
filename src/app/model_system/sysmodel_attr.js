...
export default ( $scope , sysModelResp , $source )=>{
	...
	var basicTabs = [
			...
			{ title:"profile.profile"  ,  state: "app.sysmodelattr.profile" ,  icon:" icon icon-screen-desktop "} ,

		    { title:"tag.tag"  ,  state: "app.sysmodelattr.tag" ,  icon:" icon icon-screen-desktop "} ,
			{ title:"trigger.trigger"  ,  state: "app.sysmodelattr.trigger" ,  icon:" icon icon-screen-desktop "}
	] ,
	 // device ;
	deiveTab =  { title:"nav.device"  ,  state: "app.sysmodelattr.device" ,  icon:" icon icon-screen-desktop "} ,
	// 托管 gateway 时;
	gatewayTab = 	{ title:"gateway.gateway"  ,  state: "app.sysmodelattr.gateway" ,  icon:" icon icon-screen-desktop "} ,
	tabs ;

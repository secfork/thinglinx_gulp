...
export default class  bmap  {
	...
	constructor (){
		...
		this.local =  new BMap.LocalCity() ;

        this.pointCollectionOptions = {
            size: 7,
            shape: BMAP_POINT_SHAPE_WATERDROP,
            color: 'red'
        };

        this.pointMarkerOptions = {
	...
	test(){
		console.log(   this.pointMarkerOptions )
		console.log(   pointMarkerOptions )
	}
 	

// 创建地图; 
    createMap (scope, domid, h_offset)  {
...
//  获取 当前地址,    getLocation( callback(result) );
    getLocation: this.myGeo.getLocation
